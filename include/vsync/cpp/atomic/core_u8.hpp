...
#ifndef VATOMIC_CORE_U8_Hvatomic8
    #define VATOMIC_CORE_U8_Hvatomic8
namespace vsync
{
template <> struct atomic<vuint8_t> {
    ...
    void store(vuint8_t v, memory_order order = memory_order_seq_cst) noexcept
    {
        switch (order) {
            case memory_order_release:
    ...
    vuint8_t compare_exchange_strong(
    ...
    vuint8_t
    compare_exchange_weak(vuint8_t &expected, vuint8_t desired,
                          memory_order order   = memory_order_seq_cst,
                          memory_order failure = memory_order_seq_cst) noexcept
    {
